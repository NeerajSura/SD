...
class LPIPS(nn.Module):
    ...
    def forward(self, in0, in1, normalize=False):
        # Scale the inputs to -1 to 1 if needed
        if normalize:
            in0 = 2 * in0 - 1
            in1 = 2 * in1 - 1

        # Normalize the input according to imagenet normalization
        in0_input, in1_input = self.scaling_layer(in0), self.scaling_layer(in1)

        # Get VGG outputs for both the inputs
        outs0, outs1 = self.net.forward(in0_input), self.net.forward(in1_input)
        feats0, feats1, diffs = {}, {}, {}

        # compute square of differences of each layer output
        ...
        # Aggregate the res of each layer
...
class Scalinglayer(nn.Module):
    def __init__(self):
        ...
        # Imagenet normalization for 0 to 1
...
class NetLinLayer(nn.Module):
    r'''
    a single linear layer which does 1x1 convolution
    '''
